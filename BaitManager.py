...
DEFAULT_INVENTORY_OPEN_DELAY = 0.15
DEFAULT_MATCH_DETECTED_DELAY = 0.05
DEFAULT_LEFT_CLICK_HOLD = 0.05
DEFAULT_LEFT_CLICK_INTERVAL = 0.05
DEFAULT_AFTER_DOUBLE_CLICK_DELAY = 0.15
DEFAULT_SHOW_MATCH_WINDOW = 0.0
DEFAULT_MATCH_WINDOW_DELAY = 0.0
...
def _default_settings():
    return {
        ...
        "SHOW_MATCH_WINDOW": DEFAULT_SHOW_MATCH_WINDOW,
        "MATCH_WINDOW_DELAY": DEFAULT_MATCH_WINDOW_DELAY,
    }
...
SHOW_MATCH_WINDOW = bool(
    BAIT_MANAGER_SETTINGS[
        "SHOW_MATCH_WINDOW"
    ]
)

MATCH_WINDOW_DELAY = BAIT_MANAGER_SETTINGS[
    "MATCH_WINDOW_DELAY"
]
